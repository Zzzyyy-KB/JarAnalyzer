...
public class ExpectedObjectInputStreamTest {
    ...
    public void testResolveClass() {
        ...
        try (ByteArrayOutputStream mem = new ByteArrayOutputStream();
            ...
            ExpectedObjectInputStream instance = new ExpectedObjectInputStream(in, "java.util.ArrayList", "zju.cst.aces.dependencycheck.utils.SimplePojo", "java.lang.Integer", "java.lang.Number");
            instance.readObject();
    ...
    public void testResolveClassException() throws Exception {
        ...
        ExpectedObjectInputStream instance = new ExpectedObjectInputStream(in, "java.util.ArrayList", "zju.cst.aces.dependencycheck.utils.SimplePojo");
        instance.readObject();
    }
}
