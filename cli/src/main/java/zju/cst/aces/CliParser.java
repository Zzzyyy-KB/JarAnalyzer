...
import zju.cst.aces.dependencycheck.reporting.ReportGenerator.Format;
import zju.cst.aces.dependencycheck.utils.InvalidSettingException;
...
public final class CliParser {
    ...
    private void validateArgs() throws FileNotFoundException, ParseException {
        ...
        if (isRunScan()) {
            ...
            validatePathExists(getMarkFile(), ARGUMENT.MARK);
...
//                                + "file name if the format argument is not set to ALL."))
    ...
    public String getMarkFile() {
        return line.getOptionValue(ARGUMENT.MARK);
    }
    ...
    public static class ARGUMENT {
        ...
        public static final String  MARK_SHORT = "m";
