 ...
 */
package zju.cst.aces.dependencycheck.xml.hints;

import java.util.ArrayList;
import java.util.List;
import javax.annotation.concurrent.NotThreadSafe;
import zju.cst.aces.dependencycheck.dependency.Confidence;
import zju.cst.aces.dependencycheck.dependency.Evidence;
import zju.cst.aces.dependencycheck.xml.suppression.PropertyType;
