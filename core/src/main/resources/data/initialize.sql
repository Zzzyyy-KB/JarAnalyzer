...
CREATE ALIAS update_vulnerability FOR "nvdcve.data.dependencycheck.zju.cst.aces.H2Functions.updateVulnerability";
CREATE ALIAS insert_software FOR "nvdcve.data.dependencycheck.zju.cst.aces.H2Functions.insertSoftware";
